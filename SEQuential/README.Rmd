...
![CRAN Version](https://www.r-pkg.org/badges/version/SEQ) ![Downloads](https://cranlogs.r-pkg.org/badges/grand-total/SEQ) [![R-CMD](https://github.com/CausalInference/SEQuential/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/CausalInference/SEQuential/actions/workflows/R-CMD-check.yaml) 
...
You can install the development version of SEQ from [GitHub](https://github.com/) with:
...
11.  risk.comparison - data table of comparisons between risks at end of followup
    bootstrapped
